"""BUSINESS OS Liquidation & Surplus acquisition hunter."""
import streamlit as st

from acquisition_hunter import PROFILES, estimate_max_bid, score_acquisition

st.set_page_config(page_title="BUSINESS OS — Liquidation & Surplus", page_icon="📦", layout="wide")
from auth import require_auth
require_auth()

st.title("📦 BUSINESS OS Liquidation & Surplus")
